...
//                    FileUtils.createOrExistsFile(PathUtils.getExternalDownloadsPath() + filename);
                    String fileUrl = PathUtils.getExternalDownloadsPath() + "/" + filename;
                    FileIOUtils.writeFileFromBytesByStream(fileUrl,
